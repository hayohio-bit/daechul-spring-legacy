    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <%@ taglib uri="http://www.springframework.org/security/tags" prefix="sec" %>
            ...
            <body>
                <header>
                    <nav>
                        <a href="${pageContext.request.contextPath}/" class="logo">DC-SPRING</a>
                        <div class="nav-links">
                            ...
                            <sec:authorize access="isAuthenticated()">
                                ...
                                <form name="logoutForm" action="${pageContext.request.contextPath}/customLogout" method="post" style="display:none">
